...
def majority_vote (labels):     # Большинство голосов, labels - метки в кол-ве по результату голосования
    ...
    print(winner, winner_count, ' кортеж с наибольшим повторением') # вытаскиваем из кортежа с ind [0]-1е и 2е значение
...
print(knn_classify(2, create_labled_points (['a', 'b', 'b', 'a', 'a','b','b', 'a', 'a','b','b']), [3]), '>>>>>')
