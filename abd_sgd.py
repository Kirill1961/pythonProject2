...
# Градиент квадратичной ошибки для step_size
...
def step_size_alpha_beta(theta, data, learning_rate):
    ...
    # return [squared_error_gradient(x_i, y_i, theta)[index_for_alpha_beta] * learning_rate for x_i, y_i in data
    #         for index_for_alpha_beta in range(2)]
...
minimize_stohastic(squared_error, squared_error_gradient, num_friends_three, daily_minutes, theta)
