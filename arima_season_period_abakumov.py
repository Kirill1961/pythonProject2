...
#%%
# TODO Спектральный анализ FFT -> fast Fourier transform
#  Перевод в реальные единицы  Т = 1 / f, Т - период/количество наблюдений, f - значение на оси Х
#  fft(x) - переводит ряд из временной области → в частотную,
#  fftfreq - возвращает частоты, соответствующие FFT, n — длина ряда, d — шаг по времени (например, 1 месяц)
